...
class Board:
    ...
    @overload
    def get_config(self, board_key: str, config_name: Literal["VALUE", "MINES"]) -> AbstractValue:
        ...
    ...
    def get_config(
        ...
        Size, AbstractValue, None, List[Position],
        List[str], dict[Position, str], bool
    ]:
    ...
    @overload
    def set_config(
        self, board_key: str, config_name: Literal["VALUE", "MINES"],
        value: AbstractValue
    ) -> None:
        ...
    ...
    def set_config(
        self, board_key: str, config_name: Literal[
            ...
            Size, AbstractValue, List[Position],
            Union[List[str], dict[Position, str]], bool
        ]
    ) -> None:
        if board_key not in self.board_data:
            return None
