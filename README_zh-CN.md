...
**14 Minesweeper Variants（简称 14mv）** 是一款扫雷变体的解谜游戏生成器+游戏服务器。支持多种扫雷规则组合，可生成具有**唯一解**的纸笔类谜题。

> 要浏览规则请前往 [Minesweeper Variants 规则列表](https://minesweepervariants-fanmade.github.io/rule/)
> 游戏前端项目请使用[Minesweeper Variants-Vue](https://minesweepervariants-fanmade.github.io/MinesweeperVariants-Vue/)
...
|`--output-path`|字符串|图片输出目录路径|
|`--log-path`|字符串|日志输出目录路径|
|`--lang`|字符串|输出语言代码，例如 en_US 或 zh_CN|
|`list`||列出当前所有实现的规则内容|
